	...
	$(document).ready(function(){	
		...
		$.ajax({                           	  
		       ...
		       success: function (OrderDetailList) { 
		       		...
		       		{	
		       			var temp=eval('('+str+')');
		       			alert("长度为："+temp.length);
		       			for (var i=0;i < temp.length;i++)
		       			{
		       				var trcomp="<tr>"+
		       				"<td align=center>"+temp[i].amount+"</td>"+
		       				"<td align=center>"+temp[i].price+"</td>"+
		       				"<td align=center>"+temp[i].time+"</td>"+
		       				"</tr>";
...
<body class="horizontal-menu-page"style="font-family:'楷体';">
<section>
<div class="wrapper">
