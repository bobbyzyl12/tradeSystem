...
<section>
    <!-- left side start-->
    <p style="display:none" id="orderID">${order.brokerOrderId}</p>
	        	...
	        	<div class="panel" data-collapsed="0">
                    	...
                    	<div class="panel-body">
                        	<table class="display table table-bordered table-striped" style="text-align:center;">
								<thead>
									<tr>
										<th width=45px style="text-align:center;">订单ID</th>
				  						<th width=90px style="text-align:center;">订单发出公司名</th>
									  	<th width=70px style="text-align:center;">订单类型</th>
									  	<th width=45px style="text-align:center;">购买/出售</th>
									  	<th width=45px style="text-align:center;">产品编号</th>
									  	<th width=45px style="text-align:center;">设定数量</th>
									  	<th width=45px style="text-align:center;">完成数量</th>
									  	<th width=70px style="text-align:center;">当前状态</th>
									  	<th width=90px style="text-align:center;">开始时间</th>
									  	<th width=90px style="text-align:center;">结束时间</th>
									  	<th width=45px style="text-align:center;">定价</th>
									  	<th width=45px style="text-align:center;">触发价格</th>
									</tr>
									</thead>
										<tbody>
											<tr>
	              	...
	              	<div class="panel-heading">
                    	...
                    	<div class="panel-body">
                        	<table class="display table table-bordered table-striped" style="text-align:center;">
								<thead>
									<tr>
										<th width=50px style="text-align:center;">交易对方订单ID</th>
										<th width=50px style="text-align:center;">交易数量</th>
										<th width=50px style="text-align:center;">交易价格</th>
										<th width=100px style="text-align:center;">交易时间</th>
									</tr>
									</thead>
										<tbody>
											<c:forEach items="${orderDetailList}" var="orderDetail">
								           		 <tr>
											         <td>
											         <a href="${ctx}/page/jumpToOrderDetail?orderId=${orderDetail.otherSideBrokerOrderId}">${orderDetail.otherSideBrokerOrderId}</a>
											         </td>
